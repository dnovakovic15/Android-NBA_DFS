...
class API_SendLineup extends AsyncTask<String, Object, String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            writer.write("&email=" + params[8]);
            writer.write("&player1Salary=" + Double.parseDouble(params[9]));
            writer.write("&player2Salary=" + Double.parseDouble(params[10]));
            writer.write("&player3Salary=" + Double.parseDouble(params[11]));
            writer.write("&player4Salary=" + Double.parseDouble(params[12]));
            writer.write("&player5Salary=" + Double.parseDouble(params[13]));
